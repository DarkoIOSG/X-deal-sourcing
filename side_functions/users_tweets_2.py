...
# Load your CSV file
df = pd.read_csv("cleaned_tracking_following_with_dates_2025-07-11.csv")
...
df.to_csv("cleaned_tracking_following_with_dates_2025-07-11_enriched.csv", index=False)
print("Finished. Output saved as 'cleaned_tracking_following_with_dates_2025-07-11_enriched_with_account_type.csv'")